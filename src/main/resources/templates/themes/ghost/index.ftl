...
<head>
    ...
    <title>${user.userDisplayName}'S Blog</title>
    ...
    <link rel="alternate" type="application/rss+xml" title="${user.userDisplayName}'S Blog" href="ghost/feed.xml"/>
</head>
